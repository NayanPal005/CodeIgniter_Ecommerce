...
<div class="box-content">
    <form action="save-add-manufacturer-form" enctype="multipart/form-data" method="post" style="border:1px solid #ccc; align-self: center;">
        <div class="container">
            <h1 style="text-align: center">Add Manufacturer </h1>
            <hr>
            ...
            <input type="text" placeholder="Enter manufacturer Short Description "  name="manufacturer_short_description" required>

            <label for="description"><b>Manufacturer Long Description</b></label>
            <input type="text" placeholder="Enter manufacturer Long Description "  name="manufacturer_long_description" required>
