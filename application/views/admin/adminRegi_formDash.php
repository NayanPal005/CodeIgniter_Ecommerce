...
<script src="<?php echo base_url()?>Assets/admin_Assets/<?php echo base_url()?>Assets/admin_Assets/js/
jquery-1.9.1.min.js"></script>
<script src="<?php echo base_url()?>Assets/admin_Assets/<?php echo base_url()?>Assets/admin_Assets/js/
jquery-migrate-1.0.0.min.js"></script>

<script src="<?php echo base_url()?>Assets/admin_Assets/js/
jquery-ui-1.10.0.custom.min.js"></script>

<script src="<?php echo base_url()?>Assets/admin_Assets/<?php echo base_url()?>Assets/admin_Assets/js/
jquery.ui.touch-punch.js"></script>

<script src="j<?php echo base_url()?>Assets/admin_Assets/s/modernizr.js"></script>
...
<script src="<?php echo base_url()?>Assets/admin_Assets/js/
jquery.flot.pie.js"></script>
<script src="<?php echo base_url()?>Assets/admin_Assets/js/
jquery.flot.stack.js"></script>
<script src="<?php echo base_url()?>Assets/admin_Assets/js/
jquery.flot.resize.min.js"></script>

<script src="<?php echo base_url()?>Assets/admin_Assets/js/
jquery.chosen.min.js"></script>
...
<script src="<?php echo base_url()?>Assets/admin_Assets/js/
jquery.elfinder.min.js"></script>

<script src="<?php echo base_url()?>Assets/admin_Assets/js/
jquery.raty.min.js"></script>

<script src="<?php echo base_url()?>Assets/admin_Assets/js/
jquery.iphone.toggle.js"></script>

<script src="<?php echo base_url()?>Assets/admin_Assets/js/
jquery.uploadify-3.1.min.js"></script>

<script src="<?php echo base_url()?>Assets/admin_Assets/js/
jquery.gritter.min.js"></script>

<script src="<?php echo base_url()?>Assets/admin_Assets/js/
jquery.imagesloaded.js"></script>

<script src="<?php echo base_url()?>Assets/admin_Assets/js/
jquery.masonry.min.js"></script>

<script src="<?php echo base_url()?>Assets/admin_Assets/js/
jquery.knob.modified.js"></script>
